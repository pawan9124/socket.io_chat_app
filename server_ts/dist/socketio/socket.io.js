...
const floodPrevention_1 = require("./floodPrevention");
//number of users  
let numUsers = 0;
const connectSocket = (io, socket) => {
    //when the client emits 'new message', this listens and executes
    socket.on('newMessage', (data) => __awaiter(void 0, void 0, void 0, function* () {
        const floodObjectResponse = floodPrevention_1.floodObject.protectServer(socket);
        if (!floodObjectResponse.isFlooded) {
            const afterMessage = yield (0, chat_1.addChatMessage)(data);
